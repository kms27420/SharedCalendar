...
public class DateView extends TextButton {
	private final Color CLICKED_CIRCLE_COLOR = new Color(255, 121, 98);
	...
	public void paint(Graphics g) {
		...
		} else	setForeground(isHoliday ? HOLIDAY_FG : getOriginalFg());
		super.paint(g);
	}
}
