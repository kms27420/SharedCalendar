...
public class YearMonthSelectPanel extends WindowView implements CommonButtonsListener {
	private YMDSelectListener ymdSelectListener = new YMDSelectAdapter();
	
	public YearMonthSelectPanel() {
		setOpaque(false);
	...
	public void onCheckButtonClick(ActionEvent e) {
		...
		else WindowShower.INSTANCE.showSubWindow(alertPanel, SubViewType.ALERT);
	}
